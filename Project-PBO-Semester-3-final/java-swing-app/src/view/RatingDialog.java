...
public class RatingDialog extends JDialog {
    ...
    private void submitRating() {
        ...
        // ==== FIX: Ambil building via controller dan buildingId ====
        int buildingId = room.getBuildingId();
        Building building = controller.getBuildingById(buildingId); // Pastikan method ini ada
        String buildingFaculty = (building != null && building.getFaculty() != null) ? building.getFaculty() : "UMUM";
        String userFaculty = user.getFaculty() != null ? user.getFaculty() : "";
        boolean isGuest = user.isGuest();

        if ("UMUM".equalsIgnoreCase(buildingFaculty)) {
            if (isGuest) {
            ...
            if (isGuest || !buildingFaculty.equalsIgnoreCase(userFaculty)) {
                JOptionPane.showMessageDialog(this,
                        "Hanya mahasiswa fakultas " + buildingFaculty + " yang boleh rating di gedung ini.",
        ...
        System.out.println("faculty gedung: >" + building.getFaculty() + "<");
        System.out.println("is public: " + building.isPublicFacility());
        System.out.println("faculty user: >" + user.getFaculty() + "<");
